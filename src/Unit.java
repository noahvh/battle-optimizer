public class Unit {
    ...
    public static Unit createUnit(int type, int count) {
        return switch (type) {
            ...
            // crits are mostly not calculated, but because of how simple trample damage is I figure I may as well just multiply trample attacks by (1 + crit chance) here.
            // also yes there is a crit field but it's currently not used
            case CANNON -> new Unit(count, 60, 144, 0, 128, 4, 9, true, true, false, false, true);
